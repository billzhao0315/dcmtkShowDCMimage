...
IMPLEMENT_DYNCREATE(CsplitDCMView, CView)

BEGIN_MESSAGE_MAP(CsplitDCMView, CView)
	// Standard printing commands
	ON_COMMAND(ID_FILE_PRINT, &CView::OnFilePrint)
	ON_COMMAND(ID_FILE_PRINT_DIRECT, &CView::OnFilePrint)
	ON_COMMAND(ID_FILE_PRINT_PREVIEW, &CsplitDCMView::OnFilePrintPreview)
	ON_WM_CONTEXTMENU()
	ON_WM_RBUTTONUP()
    ON_WM_CREATE()
...
BOOL CsplitDCMView::PreCreateWindow(CREATESTRUCT& cs)
{
...
void CsplitDCMView::OnDraw(CDC* pDC)
{
...
void CsplitDCMView::OnFilePrintPreview()
{
#ifndef SHARED_HANDLERS
...
BOOL CsplitDCMView::OnPreparePrinting(CPrintInfo* pInfo)
{
	// default preparation
	return DoPreparePrinting(pInfo);
}

void CsplitDCMView::OnBeginPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/)
{
	// TODO: add extra initialization before printing
}

void CsplitDCMView::OnEndPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/)
{
	// TODO: add cleanup after printing
}

void CsplitDCMView::OnRButtonUp(UINT /* nFlags */, CPoint point)
{
	ClientToScreen(&point);
	OnContextMenu(this, point);
}

void CsplitDCMView::OnContextMenu(CWnd* /* pWnd */, CPoint point)
{
#ifndef SHARED_HANDLERS
...
#ifdef _DEBUG
void CsplitDCMView::AssertValid() const
{
	CView::AssertValid();
}

void CsplitDCMView::Dump(CDumpContext& dc) const
{
	CView::Dump(dc);
}

CdcmtkShowDCMImageDoc* CsplitDCMView::GetDocument() const // non-debug version is inline
{
...
int CsplitDCMView::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
...
void CsplitDCMView::openDicoms( std::string pDicomFileIndex)
{
...
void CsplitDCMView::OnFileOpendicom()
{
...
BOOL CsplitDCMView::OnMouseWheel(UINT nFlags, short zDelta, CPoint pt)
{
    // TODO: Add your message handler code here and/or call default
